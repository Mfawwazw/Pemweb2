...
<body>
    ...
    <div class="row mx-5">
        ...
        <div class="col-12 col-md-4">
            <ul class="list-group">
                <li class="list-group-item active text-center">Daftar Harga</li>
                <li class="list-group-item text-center">TV : 4.200.000</li>
                <li class="list-group-item text-center">Kulkas : 3.100.000</li>
                <li class="list-group-item text-center">Mesin cuci : 3.800.000</li>
                <li class="list-group-item active text-center">Harga dapat berubah setiap saat</li>
            </ul>
        </div>
    </div>
</body>
